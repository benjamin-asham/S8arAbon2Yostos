...
const quiz = [
  ...
  // سؤال آية (أمثال 10:1)
  { q: "سؤال آية: الكتاب بيقول (الاِبِن الْحَكِيمُ يَسُرُّ أَبَاهُ، وَالاِبِن الْجَاهِلُ حُزْنُ أُمِّهِ) – الآية دي موجودة فين؟", options: ["أمثال 10:1", "مزمور 23", "يوحنا 3:16"], answer: 0 }
];
